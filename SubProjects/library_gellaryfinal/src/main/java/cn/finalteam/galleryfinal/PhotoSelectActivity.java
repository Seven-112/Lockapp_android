...
public class PhotoSelectActivity extends PhotoBaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    private void setTheme() {
        ...
        mIvFolderArrow.setImageResource(R.drawable.ic_gf_triangle_arrow);
        if (GalleryFinal.getGalleryTheme().getIconFolderArrow() == R.drawable.ic_gf_triangle_arrow) {
            mIvFolderArrow.setColorFilter(Color.WHITE);
        }
        ...
        BitmapDrawable bitmapDrawable = (BitmapDrawable) (GalleryFinal.getGalleryTheme().getPreviewBg());
        ...
        File newFile = new File(path + File.separator + "Temp.jpeg");
        ...
        //backgroundBlurLayer.setImageDrawable(GalleryFinal.getGalleryTheme().getPreviewBg());

        mTvSubTitle.setTextColor(Color.WHITE);
        mTvTitle.setTextColor(Color.WHITE);
        mTvChooseCount.setTextColor(Color.WHITE);
